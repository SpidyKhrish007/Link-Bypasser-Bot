...
# bot
bot_token = os.environ.get("TOKEN", "5825967511:AAFVkucerC-EdonnHhmToJPeKU8kvXFZiYg")
api_hash = os.environ.get("HASH", "19f8365d98fb11c9cd6c1eaa8b1fa4b8") 
api_id = os.environ.get("ID", "23830477")
